...
<div id="container">
   ...
   <div id="body">
      <?php if($images->num_rows() > 0) : ?>
         ...
         <div align="center"><?=anchor('employee/add','Agregar nuevo funcionario',['class'=>'btn btn-primary'])?></div>
         <hr />
         <div class="row">
      ...
      <?php else : ?>
         <div align="center">No hay ningun funcionario, <?=anchor('employee/add','agregue uno nuevo')?>.</div>
      <?php endif; ?>
   </div>
